        ...
        <div class="tabs-vertical-env">
            ...
            <div class="tab-content">
                ...
                <div class="tab-pane active" id="v-home"> 
                    ...
                    <?= $form->field($model, 'parent_id')->dropDownList($model->parent, ['prompt' => 'Chọn parent']); ?>
      ...
      $("#upload").uploadFile({
       ...
       onBeforeSend: function () {
             ...
             onSuccess: function (files, data, xhr)
        {
               ...
               $(".img-list").append("<div class=\"col-md-2 col-sm-2 col-xs-4 img_"+value[0].id+"\"><div class=\"img-tem\"><img style=\"width:150px\" src="+value[0].url+"> <input type=\"hidden\" name=\"img\" value="+value[0].name+"> <a class=\deleteFile\ href=\javascript:void(0)\ data-img="+value[0].name+" id="+value[0].id+"><i class=\"fa fa-trash-o\"></i></a></div></div>");
            });
        },

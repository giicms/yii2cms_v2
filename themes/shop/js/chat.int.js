...
! function($) {
	...
	ChartJs.prototype.init = function() {
		...
		var data = {
			...
			datasets : [{
				fillColor : "rgba(110, 140, 215, 0.6)",
				strokeColor : "#6e8cd7",
				pointColor : "#6e8cd7",
				pointStrokeColor : "rgba(110, 140, 215, 0.6)",
				data : [33, 52, 63, 92, 50, 53, 46]
			}, {
				fillColor : "rgba(220,220,220,0.6)",
				strokeColor : "#dcdcdc",
				pointColor : "#dcdcdc",
				pointStrokeColor : "rgba(220,220,220,0.6)",
				data : [15, 25, 40, 35, 32, 9, 33]
			},{
				fillColor : "rgba(220,200,250,0.6)",
				strokeColor : "#dadada",
				pointColor : "#dadada",
				pointStrokeColor : "rgba(220,200,250,0.6)",
				data : [11, 22, 30, 31, 33, 19, 1000]
			}]
		};
